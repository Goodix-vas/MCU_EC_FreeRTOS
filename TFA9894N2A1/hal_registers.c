...
void tfa98xxRetrieveLiveData(uint8_t slave_address, float *live_data)
{
	...
	if (slave_address == LEFT_AMP)
		TFA98XX_PRINT("tChip_P,T_P,activity_P,AGCenvelope_P,preLIMenvelope_P,LIMenvelope_P,AGCgain_P,preLIMgain_P,LIMgain_P,ampClip_P,damageT_P,damageFres_P,sBiasProtSS_P,sBiasClip_P,sBias_P,fRes_P,X_P,Xout_P,sideChainX_P,sideChainS_P,mbdrcAGCgain_P,mbdrcAGCenvelope_P\n");
	else if (slave_address == RIGHT_AMP)
		TFA98XX_PRINT("tChip_S,T_S,activity_S,AGCenvelope_S,preLIMenvelope_S,LIMenvelope_S,AGCgain_S,preLIMgain_S,LIMgain_S,ampClip_S,damageT_S,damageFres_S,sBiasProtSS_S,sBiasClip_S,sBias_S,fRes_S,X_S,Xout_S,sideChainX_S,sideChainS_S,mbdrcAGCgain_S,mbdrcAGCenvelope_S\n");
